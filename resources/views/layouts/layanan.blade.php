<section id="layanan" class="py-8 xs:py-12 md:py-16 lg:py-20 text-white ">
  <div class="container mx-auto w-[95%] xs:w-[90%] sm:w-full px-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 xs:gap-6 md:gap-8 text-black">
      <!-- Card 1 -->
      <div class="w-[95%] xs:w-full mx-auto text-white bg-black/40 backdrop-blur-md border-2 border-green-400/50 hover:border-green-400 rounded-xl shadow-lg p-4 xs:p-6 md:p-8 transition-all duration-300 hover:shadow-xl hover:shadow-green-400/20 transform hover:-translate-y-2">
        ...
        <div class="grid grid-cols-2 gap-4 text-sm">
          ...
          <ul class="flex justify-center items-center col-span-2 mt-4">
            <a href={{ route('layanan.layanan') }} class="w-full">
      ...
      <div class="w-[95%] xs:w-full mx-auto text-white bg-black/40 backdrop-blur-md border-2 border-green-400/50 hover:border-green-400 rounded-xl shadow-lg p-4 xs:p-6 md:p-8 transition-all duration-300 hover:shadow-xl hover:shadow-green-400/20 transform hover:-translate-y-2">
        ...
        <div class="grid grid-cols-2 gap-4 text-sm">
          <ul class="space-y-3 col-span-2">
            ...
            <li class="flex items-center transform transition-transform duration-300 hover:translate-x-2">
              <x-entypo-check class="w-5 h-5 text-green-400 mr-2" />
              <span class="text-gray-200">Revisi Unlimited</span>
            </li>
            <li class="flex items-center transform transition-transform duration-300 hover:translate-x-2">
              <x-entypo-check class="w-5 h-5 text-green-400 mr-2" />
              <span class="text-gray-200">File Source</span>
            </li>
          </ul>
          <ul class="flex justify-center items-center col-span-2 mt-4">
            <a href={{ route('layanan.layanan') }} class="w-full">
